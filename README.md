...
- [**SEO:**](https://es.wikipedia.org/wiki/Posicionamiento_en_buscadores){:target="_blank"} Estos archivos propablemente ayuden a hacer más fácil encontrar información en los videos de Mi Oficina si se llegasen a integrar en alguna página web bien indexada por los búscadores web tipo Google.
